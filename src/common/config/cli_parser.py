...
"""
    ...
    basics.add_argument('--data_root', metavar='', type=str, help='absolute path to root directory of your dataset')
    basics.add_argument('--batch_size', metavar='', type=int, help='number of samples to process in one batch')
    ...
    train_args.add_argument('--use_aux', metavar='', type=str2bool, help='used to improve training, should be disabled during runtime (independent of this config)')
    ...
    runtime_args.add_argument('--trained_model', metavar='', type=str, help='load trained model and use it for runtime')
